...
@st.cache_data
def load_data():
    return pd.read_csv(r"D:\ProjectDS\Californian_Housing_Pred\data\california_housing_train_fe.csv")

@st.cache_resource
def load_model():
    return joblib.load(r"D:\ProjectDS\Californian_Housing_Pred\models\catboost_model1.pkl")
...
# Title
st.image(r"D:\ProjectDS\Californian_Housing_Pred\src\Photo-3-1800x1000.jpg")
...
with st.sidebar.expander("About Me"):
    st.image("D:\ProjectDS\Californian_Housing_Pred\src\Screenshot 2026-06-12 164759.png")
    st.write("""
